...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::commands::lsp_upsert_language,
            ipc::commands::lsp_reset_language,
            ipc::commands::lsp_builtin_ids,
            ipc::commands::lsp_customized_ids,
            ipc::commands::lsp_overrides_get,
            ipc::commands::lsp_overrides_set,
            ipc::commands::worktree_hooks_get,
            ipc::commands::worktree_hooks_set,
            ipc::commands::agent_patterns_get,
            ipc::commands::agent_patterns_set,
            ipc::commands::agent_patterns_reset,
            ...
            ipc::commands::forge_set_issue_assignee,
